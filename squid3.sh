...
echo -e "$cyanClaro
Squid que configura uma nova versão do SQUID3 Para Ubuntu-Debiam
Nao Me Responsabilizo por erro De funcionamento ou suporte @kroz44.
$fim"
read -p "Pressione Enter By Modificado AndersonSilva......"
read -p "Digite IP Da Sua VPS: " ip
echo -e "$cyanClaro
...
echo -e "$vermelhoClaro
Configurando Seu SSH Aguarde...$fim"
...
echo -e "$verde
Configuração terminada Com Sucesso.$fim"

echo -e "$menu
By: telegram.me/kroz44
By: @BadGuy3
Canal Oficial: telegram.me/darkbluessh$fim"
